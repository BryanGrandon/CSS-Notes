...
- Hexadecimal
  ...
  Hexadecimal color codes consist of a # sign and three pairs of characters representing the intensity of the three primary colors (red, green and blue). Values can range from 00 to FF.
...
- HSL
  ...
  The main difference between HSL and RGB is that the values represent hue, saturation and lightness. Hue is measured on a scale that ranges from 0 to 360.
